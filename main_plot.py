...
if __name__ == "__main__":
    ...
    parser.add_argument("--times", type=int, default=1, help='number of random seeds, starting from 1.')
    parser.add_argument("--embedding", type=int, default=0, help="Use embedding layer in generator network")
    parser.add_argument("--train_acc", type=bool, default=False)
    parser.add_argument("--train_loss", type=bool, default=False)
    parser.add_argument("--test_acc", type=bool, default=False)
    parser.add_argument("--test_loss", type=bool, default=False)
    parser.add_argument("--bottom_acc", type=bool, default=False)
    parser.add_argument("--bottom_acc_1", type=bool, default=False)
    parser.add_argument("--bottom_acc_2", type=bool, default=False)
    parser.add_argument("--bottom_acc_3", type=bool, default=False)
    parser.add_argument("--bottom_acc_4", type=bool, default=False)
    parser.add_argument("--bottom_acc_5", type=bool, default=False)
    parser.add_argument("--unseen_test_acc", type=bool, default=False)
