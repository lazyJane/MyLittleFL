  ...
  --batch_size 32 --num_users 100 --learning_rate 0.01 --num_glob_iters 500 --E 3 --times 1
  ...
  --batch_size 32 --beta 0.01 --num_users 100 --learning_rate 0.01 --num_glob_iters 500 --E 3 --times 1
 ...
 --batch_size 32 --num_users 100 --learning_rate 0.01 --num_glob_iters 500 --E 1 \
 --personal_learning_rate 0.01 --beta 1 --lamda 15 --times 1


    python main_plot.py --dataset Mnist-alpha0.5-ratio1.0-u100 --algorithms FedKLEM_intra_cluster_PerFedavg,pFedME,FedProx,FedKLEM_PerFedAvg,PerFedavg,FedIFCA,FedKLEM,FedAvg,FedSEM,FedKLtopk\
  --batch_size 32 --E 1 --num_users 100 --num_glob_iters 200 --plot_legend 1 --test_acc True
  ...
  --batch_size 32 --E 3 --num_users 100 --num_glob_iters 200 --plot_legend 1 --test_acc True
      ...
      python main_plot.py --dataset Mnist-alpha0.5-ratio1.0-u100 --algorithms pFedME,FedProx,FedKLEM_PerFedAvg,PerFedavg,FedIFCA,FedKLEM,FedAvg,FedSEM\
