 ...
 --num_users 80 --learning_rate 0.01 --num_glob_iters 200 --E 1 --times 1 --gpu 5 > ./acc_loss_record/cifar100_r0.5/E=1/FedKLEM.out 2>&1 &
 ...
 --num_users 80 --beta 0.01 --learning_rate 0.01 --num_glob_iters 200 --E 1 --times 1 --gpu 1 > ./acc_loss_record/cifar100_r0.5/E=1/FedKLEM_PerFedAvg.out 2>&1 &
 ...
 --num_users 80 --beta 0.01 --learning_rate 0.01 --num_glob_iters 200 --E 1 --times 1 --gpu 4 > ./acc_loss_record/cifar100_r0.5/E=1/PerFedAvg.out 2>&1 &
