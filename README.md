...
python generate_niid_dirichlet.py --n_class 10 --sampling_ratio 0.2 --alpha 10.0 --n_user 10
python generate_data2.py  --n_class 10 --sampling_ratio 0.5 --alpha 1.0 --n_user 10
``
...
python main.py --dataset Mnist-alpha1.0-ratio0.5 --algorithm FedCluster --batch_size 32 --num_glob_iters 200 --local_epochs 20 --num_users 10 --lamda 1 --learning_rate 0.01 --model cnn --personal_learning_rate 0.01 --times 1 
python main.py --dataset Mnist-alpha0.1-ratio0.2 --algorithm FedIFCA --batch_size 32 --num_glob_iters 200 --local_epochs 20 --num_users 10 --lamda 1 --learning_rate 0.01 --model cnn --personal_learning_rate 0.01 --times 1
python main.py --dataset Mnist-alpha0.1-ratio0.2 --algorithm FedAvg --batch_size 32 --num_glob_iters 200 --local_epochs 20 --num_users 10 --lamda 1 --learning_rate 0.01 --model cnn --personal_learning_rate 0.01 --times 1
``
```
----
...
```
  python main_plot.py --dataset EMnist-alpha0.4-ratio0.2 --algorithms FedAvg,Fedlocal --batch_size 32 --local_epochs 20 --num_users 10 --num_glob_iters 200 --plot_legend 1
```
python main_plot.py --dataset FEMNIST --algorithms FedAvg,FedIFCA,FedKLEM --batch_size 32 --local_epochs 20 --num_users 70 --num_glob_iters 200 --plot_legend 1 --times 1 --E 1
```

```
python main_plot.py --dataset Cifar10-alpha0.4-ratio0.1 --algorithms FedAvg,FedIFCA,FedKLEM --batch_size 32 --local_epochs 20 --num_users 30 --num_glob_iters 200 --plot_legend 1 --times 1
```




python main_plot.py --dataset EMnist-alpha0.4-ratio0.1 --algorithms FedAvg,FedKLEM --batch_size 32 --local_epochs 20 --num_users 30 --num_glob_iters 200 --plot_legend 1 --E 1 --test_acc True



 python show_center_parameters.py  --show no
